...
BABYLM_DATA_PATH = "/home/s2678328/BabyLM_dataset/processed_by_me/babyLM_data" # "/home/s2678328/BabyLM_dataset/translated_file/Chinese"  # "/home/s2678328/lemmaBabylmData" #"/home/s2678328/babylmData"
MARKER_HOP_SING = "🅂"
MARKER_HOP_PLUR = "🄿"
MARKER_REV = "🅁"
BOS_TOKEN = "<BOS_TOKEN>"
...
def __perturb_shuffle_deterministic(sent, seed, shuffle):
    # Get sentence text and GPT-2 tokens
    # tokens = gpt2_original_tokenizer.encode(sent["sent_text"],truncation=True, max_length=1024 )
    encoded = gpt2_original_tokenizer(
        sent["sent_text"],
        truncation=True,
        max_length=1024,
        return_tensors=None,
...
PERTURBATIONS = {
    ...
    "lemma_en_shuffle_nondeterministic": {
        "perturbation_function": partial(perturb_shuffle_nondeterministic, rng=default_rng(0)),
        "affect_function": affect_shuffle,
        "filter_function": filter_shuffle,
        "gpt2_tokenizer": gpt2_original_tokenizer,
    ...
    "lemma_shuffle_nondeterministic": {
        "perturbation_function": partial(perturb_shuffle_nondeterministic, rng=default_rng(0)),
        "affect_function": affect_shuffle,
        "filter_function": filter_shuffle,
        "gpt2_tokenizer": gpt2_original_tokenizer,
    ...
    "lemma_en_shuffle_deterministic21": {
        "perturbation_function": partial(perturb_shuffle_deterministic, seed=21, shuffle=True),
        "affect_function": affect_shuffle,
        "filter_function": filter_shuffle,
        "gpt2_tokenizer": gpt2_original_tokenizer,
