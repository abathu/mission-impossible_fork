...
#SBATCH --job-name=perplexities
#SBATCH --output=/home/s2678328/nlp/llms-in-llms/babylm_models/perplexities/slurm-%j.out
#SBATCH --error=/home/s2678328/nlp/llms-in-llms/babylm_models/perplexities/slurm-%j.out
...
cd /home/s2678328/mission-impossible-language-models/perplexities
...
######### --------“python3 perplexities.py” 
COMMAND="python3 perplexities.py lemma_shuffle_deterministic21 lemma_shuffle_deterministic21 100M $1 randinit $NO_POS_ENCODINGS"
echo $COMMAND
eval $COMMAND
echo "
"
